      ...
      <div className="max-w-6xl mx-auto">
        <div className="mb-8 flex items-start justify-between gap-4">
          <div>
            ...
            <h1 className="text-3xl font-bold mt-2">Calendario</h1>
          </div>
          {canManage && (
            <Link
              href="/shows/new"
              className="px-4 py-2 bg-white text-black font-semibold rounded-md hover:bg-gray-200 transition flex-shrink-0"
            >
              + Nueva fecha
            </Link>
          )}
