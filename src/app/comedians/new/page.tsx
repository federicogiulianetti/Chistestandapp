  ...
  return (
    <main className="min-h-screen bg-ink text-body p-8">
      <div className="max-w-3xl mx-auto">
        <Link href="/comedians" className="text-muted hover:text-body text-sm">
          ← Volver a comediantes
        </Link>
        <h1 className="text-2xl font-bold mt-2 mb-8">Nuevo comediante</h1>
        ...
        <form action={createComedian} className="space-y-6">
         ...
         <section className="bg-surface border border-line rounded-lg p-6 space-y-4">
          ...
          <section className="bg-surface border border-line rounded-lg p-6 space-y-4">
            ...
            <p className="text-xs text-muted">Solo visible para el equipo, no se comparte con el comediante.</p>
