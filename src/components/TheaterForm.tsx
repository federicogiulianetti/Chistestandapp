...
<section className={sec}>
            ...
            <div>
              ...
              <div className="space-y-3">
                {parkings.map((p, index) => {
                  const dest = encodeURIComponent(p.value.trim())
                  return (
        ...
        <section className={sec}>
          ...
          <div>
            ...
            <input id="technician_contacts" name="technician_contacts" type="text" defaultValue={t.technician_contacts ?? ''} className={inp(false)} />
          </div>
        ...
        <section className={sec}>
          ...
          <div className="grid grid-cols-2 gap-4">
            ...
            <div>
              ...
              <input id="programmer_contact" name="programmer_contact" type="text" defaultValue={t.programmer_contact ?? ''} className={inp(false)} />
            </div>
          </div>

          <div>
            <label htmlFor="press_contacts" className={lbl}>Contactos de prensa y radios</label>
            <textarea id="press_contacts" name="press_contacts" rows={2} defaultValue={t.press_contacts ?? ''} className={inp(false)} />
          </div>
        </section>
        ...
        <section className={sec}>
          ...
          <div>
            <label htmlFor="nearest_police_station" className={lbl}>Comisaría más cercana (link Google Maps)</label>
            <input id="nearest_police_station" name="nearest_police_station" type="url"
              defaultValue={t.nearest_police_station ?? ''} placeholder="https://maps.google.com/..." className={inp(false)} />
          </div>

          <div>
            <label htmlFor="nearest_hospital" className={lbl}>Hospital más cercano (link Google Maps)</label>
            <input id="nearest_hospital" name="nearest_hospital" type="url"
              defaultValue={t.nearest_hospital ?? ''} placeholder="https://maps.google.com/..." className={inp(false)} />
          </div>

          <div>
            <label htmlFor="nearest_consulate" className={lbl}>Consulado más cercano (link Google Maps)</label>
            <input id="nearest_consulate" name="nearest_consulate" type="url"
              defaultValue={t.nearest_consulate ?? ''} placeholder="https://maps.google.com/..." className={inp(false)} />
          </div>
